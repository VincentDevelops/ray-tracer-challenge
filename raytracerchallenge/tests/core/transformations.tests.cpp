...
TEST_CASE("Multiplying by a translation matrix", "[transformations][matrix]") {
...
TEST_CASE("Multiplying by the inverse of a translation matrix", "[transformations][matrix]") {
...
TEST_CASE("Translation does not affect vectors", "[transformations][matrix]") {
	Matrix transform = Matrix::translation(5.0f, -3.0f, 2.0f);
...
TEST_CASE("A scaling matrix applied to a point", "[transformations][matrix]") {
...
TEST_CASE("A scaling matrix applied to a vector", "[transformations][matrix]") {
	Matrix transform = Matrix::scaling(2.0f, 3.0f, 4.0f);
...
TEST_CASE("Multiplying by the inverse of a scaling matrix", "[transformations][matrix]") {
	Matrix transform = Matrix::scaling(2.0f, 3.0f, 4.0f);
	Matrix inv = transform.inverse();
	Tuple v = Tuple::vector(-4.0f, 6.0f, 8.0f);
...
TEST_CASE("Reflection is scaling by a negative value", "[transformations][matrix]") {
