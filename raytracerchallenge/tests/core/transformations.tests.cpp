...
TEST_CASE("Multiplying by a translation matrix", "[transformations][matrix][tuple]") {
...
TEST_CASE("Multiplying by the inverse of a translation matrix", "[transformations][matrix][tuple]") {
	Matrix transform = Matrix::translation(5.0f, -3.0f, 2.0f);
...
TEST_CASE("Translation does not affect vectors", "[transformations][matrix][tuple]") {
	Matrix transform = Matrix::translation(5.0f, -3.0f, 2.0f);
...
TEST_CASE("A scaling matrix applied to a point", "[transformations][matrix][tuple]") {
	Matrix transform = Matrix::scaling(2.0f, 3.0f, 4.0f);
	Tuple p = Tuple::point(-4.0f, 6.0f, 8.0f);

	REQUIRE((transform * p) == Tuple::point(-8.0f, 18.0f, 32.0f));
}

TEST_CASE("A scaling matrix applied to a vector", "[transformations][matrix][tuple]") {
	Matrix transform = Matrix::scaling(2.0f, 3.0f, 4.0f);
...
TEST_CASE("Multiplying by the inverse of a scaling matrix", "[transformations][matrix][tuple]") {
	Matrix transform = Matrix::scaling(2.0f, 3.0f, 4.0f);
	Matrix inv = transform.inverse();
	Tuple v = Tuple::vector(-4.0f, 6.0f, 8.0f);
...
TEST_CASE("Reflection is scaling by a negative value", "[transformations][matrix][tuple]") {
	Matrix transform = Matrix::scaling(-1.0f, 1.0f, 1.0f);
	Tuple p = Tuple::point(2.0f, 3.0f, 4.0f);

	REQUIRE((transform * p) == Tuple::point(-2.0f, 3.0f, 4.0f));
}

TEST_CASE("Rotating a point around the x axis", "[transformations][matrix][tuple]") {
...
TEST_CASE("The inverse of an x-rotation rotates in the opposite direction", "[transformations][matrix][tuple]") {
	Tuple p = Tuple::point(0.0f, 1.0f, 0.0f);
	Matrix half_quarter = Matrix::rotation_x(rtc::PI / 4.0f);
...
TEST_CASE("Rotating a point around the y axis", "[transformations][matrix][tuple]") {
...
TEST_CASE("Rotating a point around the z-axis", "[transformations][matrix][tuple]") {
	Tuple p = Tuple::point(0.0f, 1.0f, 0.0f);
